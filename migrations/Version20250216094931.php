...
final class Version20250216094931 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE ai_analysis (id SERIAL NOT NULL, analysis_type VARCHAR(255) NOT NULL, results JSON NOT NULL, confidence_score NUMERIC(5, 2) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
